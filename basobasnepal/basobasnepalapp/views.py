...
from .models import Room, Province, Municipality, District, Booking
...
def booking(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            #Create a model instance but DON'T save to the database yet
            booking_instance = form.save(commit=False)
            
            #Manually add the data that wasn't in the form
